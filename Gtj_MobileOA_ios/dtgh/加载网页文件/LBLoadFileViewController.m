...
- (void)viewDidLoad {
    ...
    if ([suffix isEqualToString:@"docx"]){
...
//    if ([suffix isEqualToString:@"docx"]||[suffix isEqualToString:@"pdf"]||[suffix isEqualToString:@"doc"]) {
//        NSData *data = [NSData dataWithContentsOfURL:url];
//        [showUrlClicked loadData:data MIMEType:@"application/vnd.openxmlformats-officedocument.wordprocessingml.document" textEncodingName:@"UTF-8" baseURL:url];
//    }
...
//    }
//    else if ([suffix isEqualToString:@"xlsx"])
//    {
//        NSData *data = [NSData dataWithContentsOfURL:url];
...
//    }
//    else if([suffix isEqualToString:@"cebx"]){
