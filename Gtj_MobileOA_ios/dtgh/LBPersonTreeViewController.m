...
@interface LBPersonTreeViewController ()<QCheckBoxDelegate,UITableViewDataSource,UITableViewDelegate,ChooseLxPersonDelegate>
{
...
@end
@implementation LBPersonTreeViewController
...
-(void)getPartFlowPeople
{
    ...
    NSString* appintlcbh = [_savedic objectForKey:@"intlcbh"];
    ...
    [SHNetWork getFlclzdxxxksbw:intrylsh:strryxm:intbzjllsh:intcsdwlsh:xtDwlsh:dwccbm:nextgzlclsh:lcczlsh:appintlcbh:
...
-(void)partFlowPermit:(NSString*)intnextgzrylsh strnextgzrylx:(NSString*)strnextgzrylx strczrxm:(NSString*)strczrxm
{
    ...
    for (int i=0; i<listryjss.count; i++) {
        ...
        if (listryjss.count==i+1) {
            ...
            [names appendFormat:@"%@,",treenode.strgzrw ];
        }
        else
        {
            [intbzlst appendFormat:@"1,"];
    ...
    [self getSelectPersonResult:[_savedic objectForKey:@"intbzjllsh"] intczrylsh:[_savedic objectForKey:@"intczrylsh"] intnextgzlclsh:[_savedic objectForKey:@"intnextgzlclsh"] strczrxm:strczrxm intlcczlsh:intlcczlsh intrylshlst:intrylshlst intbcbhlst:intbcbhlst intgzlclshlst:intgzlclshlst strlzlxlst:strlzlxlst intgwlzlsh:[_savedic objectForKey:@"intgwlzlsh"] intbzlst:intbzlst intlcdylshlst:intlcdylshlst strnextgzrylx:strnextgzrylx intnextgzrylsh:intnextgzrylsh strzrrlxLst:strzrrlxLst lint:self.bzlcint names:names ];
    
}

-(void)getSelectPersonResult:(NSString*)intbzjllsh intczrylsh:(NSString*)intczrylsh intnextgzlclsh:(NSString*)intnextgzlclsh strczrxm:(NSString*)strczrxm intlcczlsh:(NSString*)intlcczlsh intrylshlst:(NSString*)intrylshlst intbcbhlst:(NSString*)intbcbhlst intgzlclshlst:(NSString*)intgzlclshlst strlzlxlst:(NSString*)strlzlxlst intgwlzlsh:(NSString*)intgwlzlsh intbzlst:(NSString*)intbzlst intlcdylshlst:(NSString*)intlcdylshlst strnextgzrylx:(NSString*)strnextgzrylx intnextgzrylsh:(NSString*)intnextgzrylsh strzrrlxLst:(NSString*)strzrrlxLst lint:(int)lint names:(NSString*)names;
{
    ...
    LBPersonModel *personModel = [LBPersonModel mj_objectWithKeyValues:dic];
    if (self.delegate && [self.delegate respondsToSelector:@selector(personTreeViewController:didClickedButtonWithPerson:)]) {
        [self.delegate personTreeViewController:self didClickedButtonWithPerson:personModel];
    }
