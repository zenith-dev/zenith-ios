...
- (id)initWithFrame:(CGRect)frame fjAry:(NSMutableArray*)ary type1:(int)type1 controller:(UIViewController*)contro{
    ...
    if (self) {
        ...
        fjtb=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, zszwgary.count*44+(fjgary.count>0?(30+fjgary.count*44):fjgary.count*44)) style:UITableViewStyleGrouped];
        [fjtb setBackgroundColor:[UIColor  whiteColor]];
