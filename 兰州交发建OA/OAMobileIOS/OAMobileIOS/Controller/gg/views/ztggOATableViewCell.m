...
-(void)setGgdic:(NSDictionary *)ggdic
{
    ...
    self.timelb.frame=CGRectMake(5, self.btlb.bottom, kScreenWidth-10, 18);
    self.timelb.text=[ztOASmartTime sjFromStr:[ggdic objectForKey:@"dtmfbrq"]];
    self.onelinelb.frame=CGRectMake(0, self.timelb.bottom, kScreenWidth, 0.5);
    self.frame=CGRectMake(X(self), Y(self), kScreenWidth, self.onelinelb.bottom);
}
