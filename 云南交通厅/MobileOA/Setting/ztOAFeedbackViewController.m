...
{
    [super viewDidLoad];
    [self rightButton:@"提交" image:nil sel:@selector(doSend:)];
    ...
    ViewBorderRadius(suggestionTextView, 4, 1, RGBCOLOR(230, 230, 230));
