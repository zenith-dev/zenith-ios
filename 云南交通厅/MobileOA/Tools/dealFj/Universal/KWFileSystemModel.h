...
#define SUPPORTED_PPT_PPTX_FILE_FORMAT   @"ppt pptm pptx pot potx pps ppsx dps dpt ppt pot pps dps dpt"

#define SUPPORTED_DOC_FILE_FORMAT   @"wps wpt doc docx dot dotx docm txt rtf"

#define SUPPORTED_PDF_FILE_FORMAT  @"pdf"

#define SUPPORTED_EXCEL_FILE_FORMAT @"xlsx xlsm xls xlt xltx et ett csv"

#define SUPPORTED_FILE_FORMAT @"ppt pptm pptx pot potx pps ppsx dps dpt ppt pot pps dps dpt wps wpt doc docx dot dotx docm txt rtf pdf xlsx xlsm xls xlt xltx et ett csv"
