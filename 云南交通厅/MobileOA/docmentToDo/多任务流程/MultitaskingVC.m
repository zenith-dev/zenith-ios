...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self getrwsz];
//    UILabel *zblabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 64+5, 100, 30)];
//    zblabel.textAlignment = NSTextAlignmentLeft;
//    zblabel.textColor = [UIColor blackColor];
//    zblabel.font = [UIFont systemFontOfSize:15.0f];
//    zblabel.text =@"主办:";
//    [self.view addSubview:zblabel];
//    UISwitch *mySwitch = [[UISwitch alloc] initWithFrame:CGRectMake(80, 64+5, 100, 30)];
...
-(void)selectPerson{
    ...
    [flowperson selectedPersonCallback:^(NSMutableArray *selectAry, NSMutableDictionary *storeDict) {
        ...
        selectmultrwModel.intzrrcslshLst = intzrrcslshLst;
