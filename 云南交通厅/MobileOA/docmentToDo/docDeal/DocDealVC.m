...
@property (nonatomic,strong)UITextViewPlaceHolder *dxnrtv;//短信内容
//===========end===================
...
@property (nonatomic,assign)BOOL iscsh;
...
-(void)getinfoViews:(NSDictionary *)gwxxDic
{
    ...
    dcldpsArray=[[NSMutableArray alloc]init];
    if ([gwxxDic[@"dcldps"] isKindOfClass:[NSDictionary class]]) {
        [dcldpsArray addObject:gwxxDic[@"dcldps"]];
    }else if ([gwxxDic[@"dcldps"] isKindOfClass:[NSArray class]])
    {
        [dcldpsArray addObjectsFromArray:gwxxDic[@"dcldps"]];
    }
    ...
    if ([gwxxDic[@"zcyj"] isKindOfClass:[NSDictionary class]]) {
        if (gwxxDic[@"zcyj"][@"zcyjnr"]!=nil) {
             docDealModel.clyjStr=gwxxDic[@"zcyj"][@"zcyjnr"];
        }
        if (gwxxDic[@"zcyj"][@"zcimgtz"]!=nil) {
            NSData *filecontent = [GTMBase64 decodeString:gwxxDic[@"zcyj"][@"zcimgtz"]];
            UIImage *image = [UIImage imageWithData:filecontent];
            docDealModel.dwImg=image;
        }
    ...
    docDealModel.strdxnr=[NSString stringWithFormat:@"%@",gwxxDic[@"strdxnr"]];
    ...
    else if ([doctodoModel.chrlzlx isEqualToString:@"发文"])
    {
        ...
        type=@"99";
        [docAry insertObject:@"短信内容" atIndex:1];
    ...
    UIButton *okbtn=[[UIButton alloc]initWithFrame:CGRectMake(20, 0, (kScreenWidth-40)/2.0-5, 45)];
    ...
    UIButton *seavbtn=[[UIButton alloc]initWithFrame:CGRectMake(okbtn.right+10, okbtn.top, okbtn.width, okbtn.height)];
    [seavbtn bootstrapNoborderStyle:UIColorFromRGB(0xfaaa21) titleColor:[UIColor whiteColor] andbtnFont:Font(15)];
    ViewRadius(seavbtn, 4);
    [seavbtn bk_addEventHandler:^(id sender) {
        [self zSaveYj];
    } forControlEvents:UIControlEventTouchUpInside];
    [seavbtn setTitle:@"暂存意见" forState:UIControlStateNormal];
    [footView addSubview:seavbtn];
    //流转步骤
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else
    {
        ...
        if ([docAry[indexPath.row] isEqualToString:@"基础信息"]) {
            ...
            //立项字号
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]||[doctodoModel.chrlzlx isEqualToString:@"督查签收"]) {
                ...
                blxxvlb.text=[NSString stringWithFormat:@"%@[%@]%@号",gwDic[@"lxzh"][@"strlxzhmc"],gwDic[@"lxzh"][@"intlxzhnh"],gwDic[@"lxzh"][@"intlxzhqh"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]||[doctodoModel.chrlzlx isEqualToString:@"督查签收"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"lxlb"][@"strmc"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]||[doctodoModel.chrlzlx isEqualToString:@"督查签收"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strlwdwmc"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]||[doctodoModel.chrlzlx isEqualToString:@"督查签收"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strnbyj"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]||[doctodoModel.chrlzlx isEqualToString:@"督查签收"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strbldw"]];
                
                [cell.contentView addSubview:blxxvlb];
                hightH=blxxvlb.bottom+8;
            }
            //反馈内容
            if ([doctodoModel.chrlzlx isEqualToString:@"督查反馈"]) {
                UILabel *blxxlb=[[UILabel alloc]initWithFrame:CGRectMake(15, hightH, 80, 18)];
                blxxlb.font=Font(15);
                blxxlb.textColor=[UIColor grayColor];
                blxxlb.text=@"反馈内容：";
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strfknr"]];
                
                [cell.contentView addSubview:blxxvlb];
                hightH=blxxvlb.bottom+8;
            }
            //受理编号
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                UILabel *blxxlb=[[UILabel alloc]initWithFrame:CGRectMake(15, hightH, 80, 18)];
                blxxlb.font=Font(15);
                blxxlb.textColor=[UIColor grayColor];
                blxxlb.text=@"受理编号：";
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strslbh"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"dtmslsj"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strfyfs"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strldxm"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strldhm"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"dtmbjsx"]];
            ...
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线签收"]||[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strlb"]];
            ...
            //答复内容
            if ([doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]) {
                UILabel *blxxlb=[[UILabel alloc]initWithFrame:CGRectMake(15, hightH, 80, 18)];
                blxxlb.font=Font(15);
                blxxlb.textColor=[UIColor grayColor];
                blxxlb.text=@"答复内容：";
                ...
                UILabel *blxxvlb=[[UILabel alloc]initWithFrame:CGRectMake(blxxlb.right+3, blxxlb.top, gwzhlb.width-(blxxlb.right+8), blxxlb.height)];
                blxxvlb.font=Font(15);
                blxxvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strdfyj"]];
            ...
            if([type isEqualToString:@"99"]){
                ...
                hjcdvlb.text=gwDic[@"strjsdx"];
                [cell.contentView addSubview:hjcdvlb];
                
                hjcdlb=[[UILabel alloc]initWithFrame:CGRectMake(15, hjcdvlb.bottom+8, 80, 18)];
                hjcdlb.font=Font(15);
                hjcdlb.textColor=[UIColor grayColor];
                hjcdlb.text=@"发送人：";
                [cell.contentView addSubview:hjcdlb];
                hjcdvlb=[[UILabel alloc]initWithFrame:CGRectMake(hjcdlb.right+3, hjcdlb.top, gwzhlb.width-(hjcdlb.right+8), hjcdlb.height)];
                hjcdvlb.font=Font(15);
                hjcdvlb.text=gwDic[@"strfsr"];
                [cell.contentView addSubview:hjcdvlb];
            ...
            if ([type isEqualToString:@"011"]||[type isEqualToString:@"012"]||[type isEqualToString:@"014"]||[type isEqualToString:@"015"]) {
                ...
                UILabel *hjcdvlb=[[UILabel alloc]initWithFrame:CGRectMake(hjcdlb.right+3, hjcdlb.top, gwzhlb.width-(hjcdlb.right+8), hjcdlb.height)];
                hjcdvlb.font=Font(15);
                hjcdvlb.text=[NSString stringWithFormat:@"%@",gwDic[@"strbzhjcd"]];
        ...
        }else if ([docAry[indexPath.row] isEqualToString:@"答复附件"])
        {
            ...
            if (dcldpsArray.count>0) {
                ...
                for (int i=0; i<dcldpsArray.count; i++) {
                    NSDictionary *ldpsdic=dcldpsArray[i];
                    ...
                    ldyjlb.font=Font(14);
                    ldyjlb.text=[NSString stringWithFormat:@"%@", ldpsdic[@"strpsyj"]];
                    ...
                    ldxmlb.text=[NSString stringWithFormat:@"%@  %@",ldpsdic[@"strldxm"] ,[Tools dateFromStr:[NSString stringWithFormat:@"%@",ldpsdic[@"dtmpsrq"]]]];
                    ldxmlb.font=Font(13);
        ...
        }else if ([docAry[indexPath.row] isEqualToString:@"反馈内容"]&&[doctodoModel.chrlzlx isEqualToString:@"督查反馈"]){
            ...
            clyjtv.placeholder=@"请输入反馈内容";
            clyjtv.delegate=self;
            clyjtv.tag=1003;
            clyjtv.returnKeyType=UIReturnKeyDone;
            clyjtv.font=Font(14);
            [bgImg addSubview:clyjtv];
            clyjtv.text=[NSString stringWithFormat:@"%@", gwDic[@"strfknr"]];
            UIButton *selectyjbtn=[[UIButton alloc]initWithFrame:CGRectMake(clyjtv.right, clyjtv.top, 40, clyjtv.height)];
            [selectyjbtn setBackgroundColor:UIColorFromRGB(0x1296db)];
            [selectyjbtn setTitle:@"保存" forState:UIControlStateNormal];
            ...
            [selectyjbtn addTarget:self action:@selector(saveFK:) forControlEvents:UIControlEventTouchUpInside];
            CGFloat highF=bgImg.bottom+5;
            UILabel *onelb=[[UILabel alloc]initWithFrame:CGRectMake(0, highF, kScreenWidth, 0.5)];
            [onelb setBackgroundColor:RGBCOLOR(220, 220, 220)];
            cell.contentView.height=onelb.bottom;
            NSLog(@"%@",gwDic[@"intact115"]);
            if([gwDic[@"intact115"] intValue]==0){
                clyjtv.editable = NO;
                selectyjbtn.hidden = YES;
            }
            [cell.contentView addSubview:onelb];
        }else if ([docAry[indexPath.row] isEqualToString:@"答复内容"]&&[doctodoModel.chrlzlx isEqualToString:@"政务热线答复"]){
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(20, 5, 100, 30)];
            label.text =@"答复内容:";
            label.textAlignment = NSTextAlignmentLeft;
            label.textColor = [UIColor blackColor];
            ...
            clyjtv =[[UITextViewPlaceHolder alloc]initWithFrame:CGRectMake(2, 2, bgImg.width-44, 50-4)];
            clyjtv.placeholder=@"请输入答复内容";
            clyjtv.delegate=self;
            clyjtv.tag=1004;
            clyjtv.returnKeyType=UIReturnKeyDone;
            clyjtv.font=Font(14);
            [bgImg addSubview:clyjtv];
            clyjtv.text=[NSString stringWithFormat:@"%@", gwDic[@"strdfyj"]];
            UIButton *selectyjbtn=[[UIButton alloc]initWithFrame:CGRectMake(clyjtv.right, clyjtv.top, 40, clyjtv.height)];
            [selectyjbtn setBackgroundColor:UIColorFromRGB(0x1296db)];
            [selectyjbtn setTitle:@"保存" forState:UIControlStateNormal];
            [bgImg addSubview:selectyjbtn];
            ...
            bottomBorder.backgroundColor = [UIColor colorWithWhite:0.800 alpha:1.000].CGColor;
            [selectyjbtn.layer addSublayer:bottomBorder];
            [selectyjbtn addTarget:self action:@selector(saveDF:) forControlEvents:UIControlEventTouchUpInside];
            CGFloat highF=bgImg.bottom+5;
            UILabel *onelb=[[UILabel alloc]initWithFrame:CGRectMake(0, highF, kScreenWidth, 0.5)];
            [onelb setBackgroundColor:RGBCOLOR(220, 220, 220)];
            cell.contentView.height=onelb.bottom;
        ...
        else if([docAry[indexPath.row] isEqualToString:@"短信内容"]){
            UILabel *dxnrlabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 5, 100, 30)];
            dxnrlabel.text =@"短信内容:";
            dxnrlabel.textAlignment = NSTextAlignmentLeft;
            dxnrlabel.textColor = [UIColor blackColor];
            dxnrlabel.font = [UIFont systemFontOfSize:15.0f];
            [cell.contentView addSubview:dxnrlabel];
            UIImageView *bgImg=[[UIImageView alloc]initWithFrame:CGRectMake(20, dxnrlabel.bottom, kScreenWidth-40, 70)];
            [bgImg setBackgroundColor:[UIColor clearColor]];
            [bgImg.layer setBorderWidth:1];
            [bgImg.layer setBorderColor:[[UIColor colorWithWhite:0.800 alpha:1.000] CGColor]];
            [bgImg setUserInteractionEnabled:YES];
            ...
            dxnrtv =[[UITextViewPlaceHolder alloc]initWithFrame:CGRectMake(2, 2, bgImg.width-70, 70-4)];
            dxnrtv.placeholder=@"请输入短信内容";
            dxnrtv.delegate=self;
            dxnrtv.returnKeyType=UIReturnKeyDone;
            dxnrtv.font=Font(14);
            dxnrtv.tag=1002;
            [bgImg addSubview:dxnrtv];
            dxnrtv.text=docDealModel.strdxnr;
            UIButton *savedxnr=[[UIButton alloc]initWithFrame:CGRectMake(dxnrtv.right, dxnrtv.top, 70, dxnrtv.height)];
            [savedxnr bootstrapNoborderStyle:[UIColor whiteColor] titleColor:[UIColor blueColor] andbtnFont:Font(14)];
            [savedxnr setTitle:@"保存" forState:0];
            [bgImg addSubview:savedxnr];
            CALayer *bottomBorder = [CALayer layer];
            bottomBorder.frame = CGRectMake(0, 0, 1, savedxnr.height);
            bottomBorder.backgroundColor = [UIColor colorWithWhite:0.800 alpha:1.000].CGColor;
            [savedxnr.layer addSublayer:bottomBorder];
            [savedxnr addTarget:self action:@selector(dxnrSEL) forControlEvents:UIControlEventTouchUpInside];
            CGFloat highF=bgImg.bottom+5;
            UILabel *onelb=[[UILabel alloc]initWithFrame:CGRectMake(0, highF, kScreenWidth, 0.5)];
            [onelb setBackgroundColor:RGBCOLOR(220, 220, 220)];
            cell.contentView.height=onelb.bottom;
        ...
        }else if ([docAry[indexPath.row] isEqualToString:@"下步任务"])
        {
            if (nextStepListArray.count>0) {
                ...
                if (nextStepListArray.count>0) {
                    ...
                    for (int i=0; i<nextStepListArray.count; i++) {
                        if ([nextStepListArray[i][@"stryjmc"] isEqualToString:@"返回信息员"]&&iscsh==NO) {//初始化的时候需要
                            [self specifiedxybry:i];
                            break;
                        }
                    }
                }
    ...
    if ([textView isKindOfClass:[UITextViewPlaceHolder class]]) {
        if(textView.tag==1001){
            ...
            if(textView.text.length<=500){
                ...
                docDealModel.strdxnr=textView.text;
            }else{
                [Tools showMsgBox:@"只能输入少于500字"];
                textView.text= docDealModel.strdxnr;
            }
        }else if(textView.tag==1003){
            //反馈内容
            docDealModel.strfknr = textView.text;
        }else if(textView.tag==1004){
            //答复内容
            docDealModel.strdfnr = textView.text;
        }
    }
}
#pragma mark------------保存答复内容--------------
-(void)saveDF:(UIButton *)btn{
    NSString * res = docDealModel.strdfnr;
    NSDictionary *dataDic= [[NSDictionary alloc] initWithObjectsAndKeys:gwDic[@"intdflsh"],@"intdflsh",res,@"strdfyj",gwDic[@"strlxdh"],@"strlxdh",nil];
    [self networkall:@"document" requestMethod:@"saveZwrxdf" requestHasParams:@"true" parameter:dataDic progresHudText:@"加载中..." completionBlock:^(id rep) {
        if (rep!=nil) {
            NSLog(@"%@",rep);
            //[gwlztb reloadData];
...
#pragma mark------------保存反馈内容--------------
-(void)saveFK:(UIButton *)btn{
    NSString * res = docDealModel.strfknr;
    NSDictionary *dataDic= [[NSDictionary alloc] initWithObjectsAndKeys:gwDic[@"intjsfklsh"],@"intjsfklsh",res,@"strfknr",nil];
    [self networkall:@"document" requestMethod:@"saveDcfk" requestHasParams:@"true" parameter:dataDic progresHudText:@"加载中..." completionBlock:^(id rep) {
        if (rep!=nil) {
            NSLog(@"%@",rep);
            //[gwlztb reloadData];
            [self showMessage:@"操作成功"];
...
-(void)selectChargeWay{
    ...
    popview.callback=^(int selectrow,NSString *key){
       ...
       NSString *res = [self stringFormDict:newStepDic];
        NSLog(@"%@",res);
       docDealModel.xbrwmc =newStepDic[@"stryjmc"];
       NSMutableArray *tempxbryAry=[[NSMutableArray alloc]init];
       if (![newStepDic[@"zrobj"] isEqual:[NSNull null]]) {
        ...
        if (!(intact==96||intact==127||intact==22||intact==60)) {
            ...
            if (docDealModel.xbryAry.count==1){
                ...
                NSString *xml = @"";
                if(type != @"011"){
                    xml= [NSString stringWithFormat:@"<zrobj zrrlsh=\"%@\" zrrlx=\"%@\">%@</zrobj><intzrrcslshLst>%@</intzrrcslshLst><intczrcslshLst>%@</intczrcslshLst>",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"zrrlsh"]],@"1",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"content"]],[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"intdwlsh"]],@(SingObj.unitInfo.intdwlsh_child)];
                }else{
                    xml= [NSString stringWithFormat:@"<zrobj zrrlsh=\"%@\" zrrlx=\"%@\">%@</zrobj><intczrcslshLst>%@</intczrcslshLst>",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"zrrlsh"]],@"1",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"content"]],@(SingObj.unitInfo.intdwlsh_child)];
                }
...
-(void)specifiedxybry:(int) selectrow{
    iscsh=YES;
    docDealModel.xbrwnum=selectrow;
    NSDictionary *newStepDic=docDealModel.xbrwAry[selectrow];
    docDealModel.xbrwmc =newStepDic[@"stryjmc"];
    ...
    if (!(intact==96||intact==127||intact==22||intact==60)) {
        ...
        if (docDealModel.xbryAry.count==1){
            NSDictionary *notifyDic=docDealModel.xbryAry[0];
            NSString *xml= [NSString stringWithFormat:@"<zrobj zrrlsh=\"%@\" zrrlx=\"%@\">%@</zrobj><intzrrcslshLst>%@</intzrrcslshLst><intczrcslshLst>%@</intczrcslshLst>",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"zrrlsh"]],@"1",[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"content"]],[NSString stringWithFormat:@"%@",[notifyDic  objectForKey:@"intdwlsh"]],@(SingObj.unitInfo.intdwlsh_child)];
            docDealModel.responsibleManDic = [[NSDictionary alloc] initWithObjectsAndKeys:xml,@"xml",[notifyDic objectForKey:@"content"],@"content",nil];
            docDealModel.xbrwryxm =notifyDic[@"content"];
        }
    }
...
-(void)selectPerson{
    ...
    if (intact==60) {//分流程功能
        ...
        [flowperson selectedPersonCallback:^(NSMutableArray *selectAry, NSMutableDictionary *storeDict) {
            ...
            NSMutableString *tempintzrrcslshLst=[[NSMutableString alloc]init];
            ...
            for (AddUserInfo *oamodel  in selectAry) {
                ...
                [tempintzrrcslshLst appendFormat:@"%@,",@(oamodel.intdwlsh)];
            ...
            NSString *intzrrcslshLst=@"";//责任人流水号list
            if (selectAry.count>0) {
                ...
                intzrrcslshLst=[tempintzrrcslshLst
                                substringToIndex:tempintzrrcslshLst.length-1];
            ...
            xml= [NSString stringWithFormat:@"%@<intnextgzrylsh>%@</intnextgzrylsh><intnextgzlclsh>%@</intnextgzlclsh><strzrrlxLst>%@</strzrrlxLst><strnextgzrylx>%@</strnextgzrylx><intrylshlst>%@</intrylshlst><intlcdylshlst>%@</intlcdylshlst><strlzlxlst>%@</strlzlxlst><strwcbz>%@</strwcbz><strbwcbzLst></strbwcbzLst><intbzlst>%@</intbzlst><intgzlclshlst>%@</intgzlclshlst><intbcbhlst>%@</intbcbhlst><intzrrcslshLst>%@</intzrrcslshLst><intczrcslshLst>%@</intczrcslshLst>",zrobj,storeDicts[@"intnextgzrylsh"]?:@"",newStepDic[@"intnextgzlclsh"],strzrrlxLst,storeDicts[@"strnextgzrylx"],intnewrylshlst,intlcdylshlst,intlcdylshlst,storeDicts[@"strwcbz"],intbzlst,intgzlclshlst,intbcbhlst,intzrrcslshLst,@(SingObj.unitInfo.intdwlsh_child)];
    ...
    else
    {
        if (self.isryxz==YES) {
            ...
            [ztoazdcy selectedPersonCallback:^(NSMutableArray *selectAry, NSMutableDictionary *storeDict){
                ...
                xml = [NSString stringWithFormat:@"%@<intzrrcslshLst>%@</intzrrcslshLst><intczrcslshLst>%@</intczrcslshLst>",zrobj,intzrrcslshLst,@(SingObj.unitInfo.intdwlsh_child)];
                docDealModel.responsibleManDic = [[NSDictionary alloc] initWithObjectsAndKeys:xml,@"xml",content,@"content",pepoleInfoArray,@"arrayInfo",nil];
                [gwlztb reloadData];
            }];
            [self.navigationController pushViewController:ztoazdcy animated:YES];
        }else
        {
         PopView * popview=[[PopView alloc]initWithFrame:[UIScreen mainScreen].bounds title:@"请选择人员"];
            ...
            popview.callback=^(int selectrow,NSString *key){
                ...
                NSString *res = [self stringFormDict:notifyDic];
                NSLog(@"%@",res);
...
#pragma mark--------保存短信--------
-(void)dxnrSEL{
    NSDictionary *lzdic=@{@"intgwlsh":doctodoModel.intgwlsh,@"strdxnr":docDealModel.strdxnr};
    [self networkall:@"document" requestMethod:@"modDxnr" requestHasParams:@"true" parameter:lzdic progresHudText:@"保存中..." completionBlock:^(id rep) {
        if (rep!=nil) {
            if ([[[rep objectForKey:@"root"] objectForKey:@"result"] intValue]==0) {
                [self showMessage:@"提交成功！"];
            }
...
#pragma mark----------暂存意见------
-(void)zSaveYj{
    if (docDealModel.dwImg==nil&&docDealModel.clyjStr.length==0) {
        [self showMessage:@"请输入意见"];
        return;
    }
    NSString *base64Str=@"";
    if (docDealModel.dwImg!=nil) {
    ...
    NSString*str1  = [NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"UTF-8\"?><root><clyj><yjlx>%@</yjlx><yjmc>%@</yjmc><yjnr>%@</yjnr><mrcs>%@</mrcs></clyj><imgtz>%@</imgtz></root>",
              [docDealModel.opinionSelectedDic objectForKey:@"intyjlx"]?:@"",
              [docDealModel.opinionSelectedDic objectForKey:@"stryjmc"]?:@"",
               docDealModel.clyjStr?:@"",
              [docDealModel.opinionSelectedDic objectForKey:@"mrcs"],
                      base64Str];
    NSDictionary *saveDic= [[NSDictionary alloc] initWithObjectsAndKeys:@(SingObj.userInfo.intrylsh),@"intrylsh",@(SingObj.unitInfo.intdwlsh_child),@"intcsdwlsh",str1,@"queryTermXML",nil];
    
    [self networkall:@"document" requestMethod:@"zSaveYj" requestHasParams:@"true" parameter:saveDic progresHudText:@"保存中..." completionBlock:^(id rep) {
        if (rep!=nil) {
            if ([[[rep objectForKey:@"root"] objectForKey:@"result"] intValue]==0) {
