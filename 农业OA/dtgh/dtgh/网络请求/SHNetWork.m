...
//#define url(method)   [NSString stringWithFormat:@"http://192.168.16.18:8012/OA/action/InvokeAppAction?service=%@",method] //农委OA  com.zentih.ios.nyoa
...
#define url(method)   [NSString stringWithFormat:@"http://58.144.147.238:231/action/InvokeAppAction?service=%@",method] //重新更换了IP和端口 农业OA com.zenith.nwoa
