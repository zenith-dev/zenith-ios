...
@implementation ztOAUnderLineLabel
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.shouldUnderline) {
        ...
        CGPoint rightPoint = CGPointMake(fontSize.width,
                                         self.frame.size.height);
        CGContextMoveToPoint(ctx, leftPoint.x, leftPoint.y-5);
        CGContextAddLineToPoint(ctx, rightPoint.x, rightPoint.y-5);
