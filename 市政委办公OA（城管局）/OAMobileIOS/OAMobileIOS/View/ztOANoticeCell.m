...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        noticeName = [[UILabel alloc] initWithFrame:CGRectMake(iconImg.right+5, 10, self.width-iconImg.right-5, 20)];
        ...
        noticeTime = [[UILabel alloc] initWithFrame:CGRectMake(self.width-120-10+40, 40, 80, 15)];
        ...
        detailInfo = [[UILabel alloc] initWithFrame:CGRectMake(iconImg.right+5, 40, self.width-120-iconImg.right-5+40-15, 15)];
        ...
        UIImageView *line = [[UIImageView alloc]initWithFrame:CGRectMake(0, 60-1, self.width,1)];
