...
@interface ZwxxVC ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
{
...
//            [[[[self.searchField.subviews objectAtIndex:0] subviews] objectAtIndex:0] removeFromSuperview];
    ...
    searchField.placeholder = @"输入政务信息标题";
...
-(void)initWithData{
    ...
    {
        searchBarStr =[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"UTF-8\"?> <root><strxxbt>%@</strxxbt><strztc></strztc><dtmkssj></dtmkssj><dtmjssj></dtmjssj></root>",[self UnicodeToISO88591:searchField.text]];
    }
    NSDictionary *dataDic=@{@"intCurrentPage":[NSString stringWithFormat:@"%d",iRecentPageIndex],@"intPageRows":@"10",@"queryTermXML":searchBarStr};
    [self showWaitView];
    [ztOAService getZxZwxx:dataDic Success:^(id result) {
        [self closeWaitView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.zwxxItemdic=dataListArray[indexPath.row];
    return cell;
}
