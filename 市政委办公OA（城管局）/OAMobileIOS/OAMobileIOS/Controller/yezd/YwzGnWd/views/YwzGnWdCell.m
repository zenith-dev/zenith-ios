...
-(void)setGndic:(NSDictionary *)gndic
{
    _gndic=gndic;
    titlelb.text=gndic[@"strzt"];
    namelb.text=[NSString stringWithFormat:@"%@",gndic[@"strgnmc"]];
    timelb.text=gndic[@"dtmfbsj"]? [gndic[@"dtmfbsj"] substringToIndex:16]:@"";
}
