...
- (void)checkedInsertAddressBook:(NSNotification *)notify
{
    ...
    if (grouSetArray.count>0) {
        checkTitleBar.sendMsgNumLable.text = [NSString stringWithFormat:@"(%ld)",grouSetArray.count];
        checkTitleBar.loadToPhoneNumLable.text = [NSString stringWithFormat:@"(%ld)",grouSetArray.count];
