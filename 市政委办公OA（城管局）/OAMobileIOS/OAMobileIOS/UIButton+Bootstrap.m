...
-(void)bootstrapStyle{
    ...
    //点击背景颜色
    [self setBackgroundImage:[self buttonImageFromColor: MF_ColorFromRGB(245, 245, 245)] forState:UIControlStateHighlighted];
}
-(void)defaultStyle{
    [self bootstrapStyle];
    //设置字体颜色
    ...
    //点击背景颜色
    [self setBackgroundImage:[self buttonImageFromColor:MF_ColorFromRGB(245, 245, 245)] forState:UIControlStateSelected];
}
