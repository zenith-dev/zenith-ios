...
@synthesize sendInfoLabel,opinionLabel,dealInfoLabel,sendTimeLabel;
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //处理信息(操作信息)
        dealInfoLabel= [[UILabel alloc] initWithFrame:CGRectMake(20, 5, self.width-40-100, 15)];
        ...
        sendTimeLabel= [[UILabel alloc] initWithFrame:CGRectMake(self.width-100-10, 5, 100, 15)];
        [sendTimeLabel setBackgroundColor:[UIColor clearColor]];
        [sendTimeLabel setTextAlignment:NSTextAlignmentRight];
        [sendTimeLabel setTextColor:[UIColor grayColor]];
        [sendTimeLabel setText:@""];
        [sendTimeLabel setFont:[UIFont systemFontOfSize:13]];
        [self.contentView addSubview:sendTimeLabel];
        
        //意见
        opinionLabel= [[UILabel alloc] initWithFrame:CGRectMake(20+10, dealInfoLabel.bottom+10, self.width-40-10, 20)];
        ...
        openOrCloseBtn.frame = CGRectMake(20, opinionLabel.bottom,self.width-40 , 20);
        ...
        breakLine = [[UIImageView alloc] initWithFrame:CGRectMake(20, 70-1, self.width-30, 1)];
