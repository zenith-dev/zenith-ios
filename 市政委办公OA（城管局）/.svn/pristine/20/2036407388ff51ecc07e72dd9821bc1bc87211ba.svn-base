...
@property(nonatomic,strong)NSString *userId;//用户登陆id
@property(nonatomic,strong)NSString *userKey;//登陆用户密码
@property(nonatomic,strong)NSString *userName;//登陆用户名
@property(nonatomic,strong)NSString *alldwlsh;//所有单位流水号
//服务器获取
