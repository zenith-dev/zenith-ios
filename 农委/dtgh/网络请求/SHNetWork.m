...
//#define url(method)   [NSString stringWithFormat:@"http://192.168.1.5:7001/action/InvokeAppAction?service=%@",method] //畜科院OA  com.zentih.ios.cky

//#define url(method)   [NSString stringWithFormat:@"http://106.15.56.159:80/action/InvokeAppAction?service=%@",method] //农委测试OA  com.zentih.ios.nyoa
...
#define url(method)   [NSString stringWithFormat:@"http://10.50.0.67:80/OA/action/InvokeAppAction?service=%@",method] //农委内网OA  com.zentih.ios.nyoa

//#define url(method)   [NSString stringWithFormat:@"http://192.168.16.25:8012/OA/action/InvokeAppAction?service=%@",method] //农委OA  com.zentih.ios.nyoa

//#define url(method)   [NSString stringWithFormat:@"http://106.15.56.159:80/action/InvokeAppAction?service=%@",method] //农业OA、农委外网 com.zenith.nwoa

//2020/07/27
//#define url(method)   [NSString stringWithFormat:@"http://222.177.234.121:123/action/InvokeAppAction?service=%@",method] //农科院OA com.zenith.ios.nky
...
#define TaskapiGetTjb @"taskApi.getTjb"
#define TaskapiSaveTjb @"taskApi.saveTjb"
#define TaskapiGetTjbxx @"taskApi.getTjbxx"
...
{
    if ([Tools IsNetwork]) {
        NSDictionary *dic=@{@"intrylsh":[[NSUserDefaults standardUserDefaults]objectForKey:@"userInfo"][@"intrylsh"],@"strryxm":strryxm,@"dtmfbsj1":dtmfbsj1,@"dtmfbsj2":dtmfbsj2,@"intCurrentPage":currentPage,
                            @"intPageRows":pageRows};
        NSString *str=[dic JSONString];
        NSString *randomcode=[Tools getEncryptTime];//时间戳
        NSString *verifycode=@"a2c4e6";
        NSString *key=[Tools md5:[NSString stringWithFormat:@"%@%@",verifycode,[Tools md5:[NSString stringWithFormat:@"%@%@",randomcode,verifycode]]]];
        ...
        NSString *mac =[Tools md5:[NSString stringWithFormat:@"%@%@%@",randomcode,verifycode,params]];
        NSDictionary *parameterdic=@{@"r":randomcode,@"v":verifycode,@"key":key,@"mac":mac,@"param":params,@"source_type":@"2"};
        [[AFAppDotNetAPIClient sharedClient]POST:url(TaskapiGetTjb) parameters:parameterdic success:^(AFHTTPRequestOperation * operation, id responseObject) {
            NSLog(@"%@",[responseObject JSONString]);
            completionBlock(responseObject,nil);
        } failure:^(AFHTTPRequestOperation * operation, NSError *error) {
            completionBlock(nil,errorMsg);
...
+(void)saveTjb:(NSDictionary*)pramers completionBlock:(void (^)(id rep,NSString *emsg))completionBlock{
    if ([Tools IsNetwork]) {
        ...
        NSString *mac =[Tools md5:[NSString stringWithFormat:@"%@%@%@",randomcode,verifycode,params]];
        NSDictionary *parameterdic=@{@"r":randomcode,@"v":verifycode,@"key":key,@"mac":mac,@"param":params,@"source_type":@"2"};
        [[AFAppDotNetAPIClient sharedClient]POST:url(TaskapiSaveTjb) parameters:parameterdic success:^(AFHTTPRequestOperation * operation, id responseObject) {
            NSLog(@"%@",[responseObject JSONString]);
            completionBlock(responseObject,nil);
        } failure:^(AFHTTPRequestOperation * operation, NSError *error) {
            completionBlock(nil,errorMsg);
...
+(void)getTjbxx:(NSString*)inttjblsh completionBlock:(void (^)(id rep,NSString *emsg))completionBlock{
    if ([Tools IsNetwork]) {
        NSDictionary *dic=@{@"inttjblsh":inttjblsh};
        NSString *str=[dic JSONString];
        NSString *randomcode=[Tools getEncryptTime];//时间戳
        NSString *verifycode=@"a2c4e6";
        NSString *key=[Tools md5:[NSString stringWithFormat:@"%@%@",verifycode,[Tools md5:[NSString stringWithFormat:@"%@%@",randomcode,verifycode]]]];
        ...
        NSString *mac =[Tools md5:[NSString stringWithFormat:@"%@%@%@",randomcode,verifycode,params]];
        NSDictionary *parameterdic=@{@"r":randomcode,@"v":verifycode,@"key":key,@"mac":mac,@"param":params,@"source_type":@"2"};
        [[AFAppDotNetAPIClient sharedClient]POST:url(TaskapiGetTjbxx) parameters:parameterdic success:^(AFHTTPRequestOperation * operation, id responseObject) {
            NSLog(@"%@",[responseObject JSONString]);
            completionBlock(responseObject,nil);
        } failure:^(AFHTTPRequestOperation * operation, NSError *error) {
            completionBlock(nil,errorMsg);
