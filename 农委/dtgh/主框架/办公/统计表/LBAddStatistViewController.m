...
@synthesize strryxm_tf,strdezw_tf,dtmrsjs_tf,strsjgzqk_tv,strlslzfwqk_tv,strlzfwjdqk_tv,stryt_tv,strzdlzqk_tv,strlzjwqk_tv,strqt_tv,datePicker,strbfzy_tv;
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    strsjgzqk_tv.placeholder=@"请输入把政治建设摆在首位";
