...
-(void)initview:(NSDictionary*)noticedic
{
    ...
    //内容
    nrwb=[[UIWebView alloc]initWithFrame:CGRectMake(0, fjhigh+10, W(fzview), 30)];
    ...
    //附件
    fzview.frame=CGRectMake(X(fzview), Y(fzview), W(fzview), YH(nrwb)+30);
