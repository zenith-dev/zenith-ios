...
{
    [SVProgressHUD showWithStatus:@"加载中..."];
    [SHNetWork getPartFlowPeople:[_savedic objectForKey:@"strdwccbm"] intlcczlsh:[_savedic objectForKey:@"intlcczlsh"] intdwlsh:[_savedic objectForKey:@"intdwlsh"] intbzjllsh:[_savedic objectForKey:@"intbzjllsh"] completionBlock:^(id rep, NSString *emsg) {
        if (!emsg) {
            NSLog(@"%@",[rep JSONString]);
            if ([[rep objectForKey:@"flag"] intValue]==0) {
